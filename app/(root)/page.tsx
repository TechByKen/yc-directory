...
export default async function Home({searchParams}: {searchParams: Promise<{query?: string}>}) {
 ...
 return (
    ...
    <section className="w-full bg-pink-500 min-h-[530px] pattern flex justify-center items-center flex-col py-10 px-6">
       ...
       <p className="!max-w-3xl font-medium text-[20px] text-white max-w-2xl text-center break-words">Submit Ideas, Vote on Tones, and Get Noticed in Virtual Competitions.</p>
